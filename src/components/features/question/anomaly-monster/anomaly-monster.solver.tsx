          ...
          <div className="max-w-[95%] mx-auto p-2">
            ...
            <div className="text-center mt-2 mb-4">
              ...
              <h3 className="mt-1 text-lg text-gray-700 font-medium leading-relaxed tracking-tight">
                ...
                <strong>bentuk tubuh</strong>, dan <strong>mulut</strong>{' '}
                monster. Gunakan pohon tersebut untuk meneliti setiap monster.
                Isi <strong>form analisis</strong> untuk mencatat ciri-ciri
