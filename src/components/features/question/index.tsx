...
import CipherCreator from "@/components/features/question/cipher-n/cipher-n.creator";
...
export const createQuestionComponent: Record<QuestionTypeEnum, ComponentType<BaseCreatorProps>> = {
...
export const solveQuestionComponent: Record<QuestionTypeEnum, ComponentType<BaseSolverProps>> = {
