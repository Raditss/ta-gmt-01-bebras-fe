...
const kenneyMonsterSpritesheet: KenneyMonsterSpritesheet = {
  ...
  textures: {
    ['default']: {
      body: [
        {
          source: 'body_white_A.png',
          x: 1036,
          y: 2588,
          width: 330,
          height: 330
        },
        { source: 'body_white_B.png', x: 0, y: 768, width: 384, height: 384 },
        {
          source: 'body_white_C.png',
          x: 1366,
          y: 1992,
          width: 282,
          height: 388
        },
        { source: 'body_white_D.png', x: 384, y: 728, width: 348, height: 364 },
        {
      ...
      legs: [
        ...
        {
          source: 'leg_white_C.png',
          x: 2260,
          y: 1408,
          width: 158,
          height: 248
        },
        { source: 'leg_white_D.png', x: 2560, y: 0, width: 142, height: 244 },
        { source: 'leg_white_E.png', x: 384, y: 1928, width: 204, height: 218 }
      ],
      arms: [
        { source: 'arm_white_A.png', x: 2096, y: 0, width: 164, height: 352 },
        {
        ...
        {
          source: 'arm_white_D.png',
          x: 2090,
          y: 2406,
          width: 184,
          height: 394
        },
        { source: 'arm_white_E.png', x: 2542, y: 488, width: 142, height: 298 }
      ],
      horns: [
        {
    ...
    [MonsterPartType.BODY]: [
      { source: 'body_blue_A.png', x: 732, y: 944, width: 330, height: 330 },
      { source: 'body_blue_B.png', x: 0, y: 384, width: 384, height: 384 },
      { source: 'body_blue_C.png', x: 1354, y: 0, width: 282, height: 388 },
      { source: 'body_blue_D.png', x: 384, y: 1092, width: 348, height: 364 },
      { source: 'body_blue_E.png', x: 1366, y: 2380, width: 264, height: 500 },
      { source: 'body_blue_F.png', x: 732, y: 0, width: 340, height: 472 },
      { source: 'body_dark_A.png', x: 1062, y: 944, width: 330, height: 330 },
      { source: 'body_dark_B.png', x: 0, y: 0, width: 384, height: 384 },
      { source: 'body_dark_C.png', x: 1354, y: 388, width: 282, height: 388 },
      { source: 'body_dark_D.png', x: 384, y: 364, width: 348, height: 364 },
      { source: 'body_dark_E.png', x: 1394, y: 776, width: 264, height: 500 },
      { source: 'body_dark_F.png', x: 696, y: 2400, width: 340, height: 472 },
      { source: 'body_green_A.png', x: 1036, y: 2258, width: 330, height: 330 },
      { source: 'body_green_B.png', x: 0, y: 1536, width: 384, height: 384 },
      { source: 'body_green_C.png', x: 1072, y: 388, width: 282, height: 388 },
      { source: 'body_green_D.png', x: 384, y: 0, width: 348, height: 364 },
      { source: 'body_green_E.png', x: 1648, y: 1776, width: 264, height: 500 },
      { source: 'body_green_F.png', x: 732, y: 472, width: 340, height: 472 },
      { source: 'body_red_A.png', x: 1036, y: 1928, width: 330, height: 330 },
      { source: 'body_red_B.png', x: 0, y: 1920, width: 384, height: 384 },
      { source: 'body_red_C.png', x: 1072, y: 0, width: 282, height: 388 },
      { source: 'body_red_D.png', x: 0, y: 2304, width: 348, height: 364 },
      { source: 'body_red_E.png', x: 1636, y: 0, width: 264, height: 500 },
      { source: 'body_red_F.png', x: 384, y: 1456, width: 340, height: 472 },
      { source: 'body_white_A.png', x: 1036, y: 2588, width: 330, height: 330 },
      { source: 'body_white_B.png', x: 0, y: 768, width: 384, height: 384 },
      { source: 'body_white_C.png', x: 1366, y: 1992, width: 282, height: 388 },
      { source: 'body_white_D.png', x: 384, y: 728, width: 348, height: 364 },
      { source: 'body_white_E.png', x: 1630, y: 2380, width: 264, height: 500 },
      { source: 'body_white_F.png', x: 724, y: 1456, width: 340, height: 472 },
      {
        source: 'body_yellow_A.png',
        x: 1064,
        y: 1274,
        width: 330,
        height: 330
      },
      { source: 'body_yellow_B.png', x: 0, y: 1152, width: 384, height: 384 },
      {
        source: 'body_yellow_C.png',
        x: 1366,
        y: 1604,
        width: 282,
        height: 388
      },
      { source: 'body_yellow_D.png', x: 348, y: 2304, width: 348, height: 364 },
      {
    ...
    [MonsterPartType.LEG]: [
      ...
      { source: 'leg_blue_C.png', x: 2260, y: 1656, width: 158, height: 248 },
      { source: 'leg_blue_D.png', x: 2418, y: 0, width: 142, height: 244 },
      { source: 'leg_blue_E.png', x: 408, y: 2668, width: 204, height: 218 },
      { source: 'leg_dark_A.png', x: 2418, y: 2486, width: 144, height: 334 },
      { source: 'leg_dark_B.png', x: 2694, y: 698, width: 110, height: 298 },
      { source: 'leg_dark_C.png', x: 2274, y: 1904, width: 158, height: 248 },
      { source: 'leg_dark_D.png', x: 2424, y: 916, width: 142, height: 244 },
      { source: 'leg_dark_E.png', x: 1064, y: 1604, width: 204, height: 218 },
      { source: 'leg_green_A.png', x: 2274, y: 2486, width: 144, height: 334 },
      { source: 'leg_green_B.png', x: 2684, y: 400, width: 110, height: 298 },
      { source: 'leg_green_C.png', x: 2260, y: 0, width: 158, height: 248 },
      { source: 'leg_green_D.png', x: 2562, y: 2302, width: 142, height: 244 },
      { source: 'leg_green_E.png', x: 1394, y: 1276, width: 204, height: 218 },
      { source: 'leg_red_A.png', x: 2274, y: 2152, width: 144, height: 334 },
      { source: 'leg_red_B.png', x: 2690, y: 1702, width: 110, height: 298 },
      { source: 'leg_red_C.png', x: 1912, y: 2012, width: 158, height: 248 },
      { source: 'leg_red_D.png', x: 2542, y: 244, width: 142, height: 244 },
      { source: 'leg_red_E.png', x: 204, y: 2668, width: 204, height: 218 },
      { source: 'leg_white_A.png', x: 2418, y: 2152, width: 144, height: 334 },
      { source: 'leg_white_B.png', x: 2704, y: 2000, width: 110, height: 298 },
      { source: 'leg_white_C.png', x: 2260, y: 1408, width: 158, height: 248 },
      { source: 'leg_white_D.png', x: 2560, y: 0, width: 142, height: 244 },
      { source: 'leg_white_E.png', x: 384, y: 1928, width: 204, height: 218 },
      { source: 'leg_yellow_A.png', x: 2398, y: 582, width: 144, height: 334 },
      { source: 'leg_yellow_B.png', x: 2704, y: 2298, width: 110, height: 298 },
      { source: 'leg_yellow_C.png', x: 1894, y: 2638, width: 158, height: 248 },
      { source: 'leg_yellow_D.png', x: 2424, y: 1160, width: 142, height: 244 },
      { source: 'leg_yellow_E.png', x: 0, y: 2668, width: 204, height: 218 }
    ],
    [MonsterPartType.ARM]: [
      { source: 'arm_blue_A.png', x: 2234, y: 352, width: 164, height: 352 },
      { source: 'arm_blue_B.png', x: 2804, y: 548, width: 102, height: 322 },
      { source: 'arm_blue_C.png', x: 1854, y: 862, width: 196, height: 362 },
      { source: 'arm_blue_D.png', x: 1912, y: 1224, width: 184, height: 394 },
      { source: 'arm_blue_E.png', x: 2432, y: 1706, width: 142, height: 298 },
      { source: 'arm_dark_A.png', x: 2234, y: 704, width: 164, height: 352 },
      { source: 'arm_dark_B.png', x: 2798, y: 996, width: 102, height: 322 },
      { source: 'arm_dark_C.png', x: 1658, y: 862, width: 196, height: 362 },
      { source: 'arm_dark_D.png', x: 2090, y: 2012, width: 184, height: 394 },
      { source: 'arm_dark_E.png', x: 2562, y: 2004, width: 142, height: 298 },
      { source: 'arm_green_A.png', x: 2260, y: 1056, width: 164, height: 352 },
      { source: 'arm_green_B.png', x: 2800, y: 1672, width: 102, height: 322 },
      { source: 'arm_green_C.png', x: 1900, y: 0, width: 196, height: 362 },
      { source: 'arm_green_D.png', x: 2050, y: 362, width: 184, height: 394 },
      { source: 'arm_green_E.png', x: 2562, y: 2546, width: 142, height: 298 },
      { source: 'arm_red_A.png', x: 2096, y: 1502, width: 164, height: 352 },
      { source: 'arm_red_B.png', x: 2812, y: 1318, width: 102, height: 322 },
      { source: 'arm_red_C.png', x: 1658, y: 500, width: 196, height: 362 },
      { source: 'arm_red_D.png', x: 2050, y: 756, width: 184, height: 394 },
      { source: 'arm_red_E.png', x: 2418, y: 1408, width: 142, height: 298 },
      { source: 'arm_white_A.png', x: 2096, y: 0, width: 164, height: 352 },
      { source: 'arm_white_B.png', x: 2780, y: 2596, width: 102, height: 322 },
      { source: 'arm_white_C.png', x: 1894, y: 2276, width: 196, height: 362 },
      { source: 'arm_white_D.png', x: 2090, y: 2406, width: 184, height: 394 },
      { source: 'arm_white_E.png', x: 2542, y: 488, width: 142, height: 298 },
      { source: 'arm_yellow_A.png', x: 2096, y: 1150, width: 164, height: 352 },
      { source: 'arm_yellow_B.png', x: 2800, y: 226, width: 102, height: 322 },
      { source: 'arm_yellow_C.png', x: 1854, y: 500, width: 196, height: 362 },
      { source: 'arm_yellow_D.png', x: 1912, y: 1618, width: 184, height: 394 },
      { source: 'arm_yellow_E.png', x: 2560, y: 1404, width: 142, height: 298 }
    ],
    ...
    ['eyes']: [
      ...
      {
        source: 'eye_feminine_closed.png',
        x: 864,
        y: 2872,
        width: 100,
        height: 36
      ...
      { source: 'eye_dead.png', x: 620, y: 2230, width: 64, height: 64 },
      { source: 'eye_human.png', x: 2180, y: 2820, width: 128, height: 138 },
      {
