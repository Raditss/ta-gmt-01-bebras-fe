...
import {
  ...
  Condition,
  Finish,
} from "@/model/decision-tree-2/create-question/model";
...
import { extractSpriteOptions } from "@/components/solvers/decision-tree/helper";
import {
...
export default function DecisionTree2Creator({
  questionId,
  initialData,
}: BaseCreatorProps) {
